...
def image_crop_center(input_image, centeR0_rect, pad_value=0, warning=True, debug=True):
	'''
	...
	parameters:
		centeR0_rect:	a list contains [center_x, center_y, (crop_width, crop_height)]
	...
	# centeR0_rect and pad_value are checked in get_crop_bbox and pad_around functions
	...
	crop_bbox = get_center_crop_bbox(centeR0_rect, im_width, im_height, debug=debug)
